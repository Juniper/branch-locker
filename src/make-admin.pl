...
make-admin.pl - Quick script to make a user an admin.
...
my $link = DBWrap::find_or_create_row_from_columns({
    'database' => $database_name,
    'schema'   => $schema_name,
...
die "Failed to make user an admin.\n" if (! defined $link);
